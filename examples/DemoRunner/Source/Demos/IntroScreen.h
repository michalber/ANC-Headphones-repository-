...
//        addAndMakeVisible (logo);
		background = Drawable::createFromImageData(BinaryData::rysunek_svg, BinaryData::rysunek_svgSize);
    ...
    {      
		background->setBoundsToFit(getLocalBounds().expanded(10, 0), Justification::verticallyCentred, true);
