/*
  ==============================================================================
    ...
    constants.h
    Created: 27 Dec 2019 12:23:36pm
    Author:  michu
...
const long unsigned int FILTER_LENGTH = 512;
const long unsigned int FX_FILTER_LENGTH = 156;
const float LMS_LEAK_FACTOR = 0.9999f;
const float LMS_STEP_SIZE = 0.001f;
const float SEC_PATH_LMS_STEP_SIZE = 0.01f;
...
const std::array<float, FX_FILTER_LENGTH> FX_FILTER_COEFFS = {
		0.345302,
		0.683373,
		0.176932,
		-0.452794,
...
const std::array<float, ANTYALIAS_FILTER_LENGTH> ANTYALIAS_FILTER_COEFFS = {
